                                    ...
                                    <form >
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="address_type" class="form-control" id="address_type" >
                                                        @if($user_address->address_type == 'HOME')
                                                        <option value="HOME" selected>Home</option>
                                                        <option value="OFFICE">Office</option>
                                                        <option value="OTHER">Other</option>
                                                        @elseif($user_address->address_type == 'OFFICE')
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control border-form-control" value="{{ $user_address->address_line_1 }}" id="address_line_1" placeholder="Address line 1" type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Address line 2 <span class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="{{ $user_address->address_line_2 }}" id="address_line_2" placeholder="Address line 2" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="" id="">
                                                    ...
                                                    <input  class="form-control border-form-control" id="pac-input" type="text" value="{{ $user_address->map_address }}" placeholder="Enter map location" />
                                                </div>
                                                <div id="map" style="display: none"></div>
                                                <input type="hidden" id="map_address" value="{{ $user_address->map_address }}">
                                                <input type="hidden" id="lat" value="{{ $user_address->lat }}">
                                                <input type="hidden" id="lng" value="{{ $user_address->lng }}">
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="locality" id="locality" class="form-control" >{{ $user_address->locality }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <button type="button" class="btn  btn-lg btn-secondary" id="update_adderss_btn"> Update Address </button>
                                            </div>
                                        </div>
...
@section('js')
    <script>
        ...
        $('#update_adderss_btn').click(function (){
            let address_id = "{{ $user_address->address_id }}"
            ...
            if (address_line_1 == '' || address_line_2 == '' ||  address_type == ''|| map_address == '' || lat == '' || lng == ''){
                ...
                $.ajax({
                    method: "POST",
                    url: "{{ $data['image_url'].'api/User/update_address' }}",
                    data: {
                        Authorization: token,
