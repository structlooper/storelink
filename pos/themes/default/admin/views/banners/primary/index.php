...
<div class="box">
    ...
    <div class="box-content">
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="" class="table table-bordered table-hover table-striped">
                        ...
                        <?php 
                        if(isset($banners) or !is_null($banners)) {
        ...
        <ul class="dropdown-menu pull-right" role="menu">
            <li><a href="<?= admin_url('banners/primary_edit/').$banner['primary_banner_id'] ?>"><i class="fa fa-file-text-o"></i> EDIT</a></li>
        
            <li class="divider"></li>
            <li><a href="<?= admin_url('banners/primary_delete/').$banner['primary_banner_id'] ?>" ><i class="fa fa-trash-o"></i> DELETE</a></li>
            </ul>
        </div></div>
                            </td>
                        </tr>
