...
class Sales extends MY_Controller
{
    ...
    public function getSales($warehouse_id = null)
    {
        ...
        $add_delivery_link = '<button type="button" class="btn" style="margin-left: 5px;" onclick="assignFunction($1)"><i class="fa fa-truck"></i> &nbsp;&nbsp;&nbsp;'.lang('add_delivery').'</button>';
...
//        $add_delivery_link = anchor('admin/sales', '<i class="fa fa-truck"></i> ' . lang('add_delivery'), 'onclick="assignFunction($1)"');
