    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <?php echo form_input('latitude', '', 'class="form-control" id="latitude" , onblur="resetMap()"'); ?>
            </div>
            <div class="form-group">
                <label class="control-label" for="longitude"><?php echo $this->lang->line('longitude'); ?></label>
                <?php echo form_input('longitude', '', 'class="form-control" id="longitude" , onblur="resetMap()"'); ?>
            </div>
            <div class="form-group">
                ...
                <div id="showonPolygon" style=""><!--<b>Area:</b>-->
                    ...
                    <?php echo form_input('area', '', 'class="form-control" id="area"'); ?>
                </div>
